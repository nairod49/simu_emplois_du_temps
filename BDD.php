...
// fonction qui permet l'insertion de donnée réel depuis un fichier 
...
//fonction qui regroupe plusieurs fonction d'insertion de données dans le programme
	function base_tout(){
		base_formation();
		base_ue();
		base_matiere();
...
//fonction qui permet d'effacer toute les données présente dans la base
...
//fonction qui permet d’insérer les donné des professeurs dans le programme
function base_prof(){
	global $bdd;
	global $list_prof;
...
//fonction qui permet d’insérer les donné des formations dans le programme
...
//fonction qui permet d'inserer dans la base de donnée un formation
...
//fonction qui permet d’insérer les donné des UE dans le programme
function base_ue(){
...
//fonction qui permet d'insérer un UE dans la base de donnée
...
//fonction qui permet d’insérer les donné des matières dans le programme
...
//fonction qui permet d'insérer une matière dans la base de donnée
...
//fonction qui permet d’insérer les donné des catégories dans le programme
...
//fonction qui permet d'insérer une catégorie dans la base de donnée
...
//fonction qui permet la mise a jour du nombre d'élève pour la table partie
function ajoutnb_eleve(categorie $cat){
	global $bdd;
	$str="Update partie set nb_etudiants=$cat->effectif where id_partie=$cat->id";
	$bdd->query($str);
}


////fonction qui permet d’insérer les donné des étudiants dans le programme
...
//fonction qui permet d'insérer un étudaint dans la base de donnée
...
//fonction qui permet d'insérer le choix des matières d'un étudiant dans la base de donnée
...
//fonction qui permet d’insérer les donné des groupes dans le programme
...
//fonction qui permet d'insérer un groupe dans la base de donnée
...
//fonction qui permet d'insérer le le groupe de l'étudiant dans la base de donnée
...
////fonction qui permet d’insérer les donné des affectations dans le programme
...
//fonction qui permet d'insérer un professeur dans la base de donnée
...
//fonction qui permet d'insérer une classe dans la basse de donnée
